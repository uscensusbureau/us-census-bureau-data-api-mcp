...
export class FetchDatasetVariablesTool extends BaseTool<FetchDatasetVariablesArgs> {
  ...
  inputSchema: Tool["inputSchema"] = FetchDatasetVariablesArgsSchema as Tool["inputSchema"];
  ...
  async handler(args: FetchDatasetVariablesArgs): Promise<{ content: ToolContent[] }> {
		try {
